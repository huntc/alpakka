...
class MqttSessionSpec
  ...
  "MQTT client connector" should {
    ...
    // FIXME: This test is disabled until we can somehow resolve https://github.com/akka/akka/issues/17997#issuecomment-429670321
    "disconnect when connection lost" ignore {
      val session = ActorMqttClientSession(settings)
